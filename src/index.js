    ...
    fetch(
      ...
      .then((json) => {
        ...
        for (const emote of Object.keys(resEmotions)) {
          ...
          let readOut = document.createTextNode(
            `${Math.ceil(resEmotions[emote])}`
          );
...
function tutorialsHelp() {
  ...
  document.getElementById("text-help").addEventListener("mouseover", (e) => {
    ...
    document.querySelector("#dear-diary textarea").style.border =
      "3px solid #8A4D0F";
  });
  ...
  document.getElementById("submit-help").addEventListener("mouseover", (e) => {
    ...
    document.querySelector('#dear-diary input[type="submit"]').style.border =
      "3px solid #8A4D0F";
  });
  ...
  document.getElementById("clear-help").addEventListener("mouseover", (e) => {
    ...
    document.getElementById("clear-the-mind").style.border =
      "3px solid #8A4D0F";
  });
